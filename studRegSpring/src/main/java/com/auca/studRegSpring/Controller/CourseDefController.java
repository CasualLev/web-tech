...
import com.auca.studRegSpring.Service.CourseDefService;
    ...
    public ResponseEntity<?> createDef(@RequestBody CourseDefinition crsDef){
        if(crsDef != null ){
            ...
            if(message != null){
                ...
                return new ResponseEntity<>("Course could not Save",HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }
        else {
    ...
    public ResponseEntity<String> updateDef(@PathVariable String code, @RequestBody CourseDefinition crsDef) {
        if (crsDef != null) {
            ...
            if (message != null) {
                ...
                return new ResponseEntity<>("Course could not update", HttpStatus.NOT_FOUND);
            }
        } else {
